...
=======
def test_can_create_a_new_token_with_a_15_char_name_and_peg_it():
    # this is as large of a name as we can test with apparently.
    new_account_key = ("a" + get_shell_output("uuidgen").replace("-", ""))[:15]
    amount = amount_in_wei(9)
    new_currency = test_utilities.create_new_currency(
        amount,
        new_account_key,
